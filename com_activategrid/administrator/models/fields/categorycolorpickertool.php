 ...
 * @since       11.3
 */
class JFormFieldCategorycolorpickertool extends JFormField
{
	/**
	 * The form field type.
	 *
	...
	protected $type = 'Color';
        ...
        function __construct($name="", $id="", $color) {           
            $this->name = $name;
            $this->id = $id;
            $this->value = $color;
        }
	...
	protected function getInput()
	{
		...
		else
		{
			...
			return '<input type="text" name="jform[' . $this->name . ']" id="' . $this->id . '"' . ' value="'
